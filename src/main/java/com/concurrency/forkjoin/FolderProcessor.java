...
public class FolderProcessor extends RecursiveTask<List<String>> {
    ...
    public static void main(String[] args)
    {
        ...
        FolderProcessor system = new FolderProcessor(args[0], "log");
        FolderProcessor apps = new FolderProcessor(args[0], "md");
        FolderProcessor documents = new FolderProcessor(args[0], "rb");
